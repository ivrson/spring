 ...
 * File			: /WEB-INF/views/system/system-reject.jsp
 * Function		:
 * Notes		:
...
<%@ page info="/WEB-INF/views/system/system-reject.jsp" %>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrap">
	...
	<section id="container">
		<div class="errorDesc">
			...
			<p>SYSTEM REJECT(Reason: You have to re-login or You don't have rights for this menu)</p>
