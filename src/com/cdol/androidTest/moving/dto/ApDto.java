 ...
 */
public class ApDto {
	private String bus_org_id	= "";
	private String bus_cors_id	= "";
	
	public String getBus_org_id() {
		return bus_org_id;
	}
	public void setBus_org_id(String bus_org_id) {
		this.bus_org_id = bus_org_id;
	}
	public String getBus_cors_id() {
		return bus_cors_id;
	}
	public void setBus_cors_id(String bus_cors_id) {
		this.bus_cors_id = bus_cors_id;
	}
