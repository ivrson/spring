 ...
 *				: [20140306134000][pluto@i-popcorn.co.kr][CREATE: Initial Release]
 */
...
public class HttpClient {
	...
	public String connect(String requestJSON, int timeout) {
		...
		try {
			...
			//logger.info("***************************************************************************************");
			//logger.info("REQ: " + requestJSON);
			//logger.info("RES: " + responseJSON);
			//logger.info("***************************************************************************************");
	...
	public String connect(HttpBean httpBean, int timeout) {
		...
		try {
			...
			conn.setRequestProperty("accept", "application/" + httpBean.getAcceptType());
			conn.setDoInput(true);
			conn.setDoOutput(true);
