...
public class FileManage {
	...
	public static String savePath(String path, int usr_idx){
	...
	public static String uploadFile(MultipartFile file, String path, int usr_idx){
		...
		if(file != null){
			String fullPath = savePath(path, usr_idx) + "/" + file.getOriginalFilename();
	...
	public static String findPath(int usr_idx, String gbn){
		...
		if(gbn.equals("p")){
			path = path + usr_idx + "_P_" + Datetime.getDatetimeToString("mmss")+ ".png";
		}else if(gbn.equals("g")){
			path = path + usr_idx + "_G_" +Datetime.getDatetimeToString("mmss")+ ".png";
		}else{
			path = path + usr_idx + Datetime.getDatetimeToString("mmss")+ ".png";
		}
		return path;
